		...
		buildSlider: function (options) {
			return this.each(function () {
				...
				slider.sliderBar.on("mousedown.mb_slider", function (e) {
					$slider.addClass("mb-slider-mousedown");
					$slider.removeClass("mb-slider-mouseup");
					...
					$(document).on("mousemove.mb_slider", function (e) {
						$slider.addClass("mb-slider-mousemove");
						$slider.removeClass("mb-slider-mouseup");
					...
					$(document).on("mouseup.mb_slider", function () {
						$slider.addClass("mb-slider-mouseup");
						$slider.removeClass("mb-slider-mousedown");
						$slider.removeClass("mb-slider-mousemove");
						$(document).off("mousemove.mb_slider").off("mouseup.mb_slider");
						if (slider.options.onStop)
							slider.options.onStop(slider);

					if (slider.options.onSlideUp){
						slider.options.onSlideUp(slider);
					}
					});
